...
import HistoryModal from "../inventory/HistoryModal";
...
import RecordGrid from "../inventory/RecordGrid";
            ...
            <div className="px-5 pb-5">
              ...
              {group.items.length ? (
                ...
                <EmptyState
                  ...
                  description="Add a finished product to start recording daily stock."
                />
              )}
            </div>
          </motion.div>
